#### GxEPD2_AVR: a simple E-Paper display library for Arduino for SPI e-paper display panels from Dalian Good Display and SPI e-paper display boards from Waveshare
