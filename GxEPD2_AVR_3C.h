...
struct GxEPD2_AVR_3C_ScreenDimensionType
{
  uint16_t width;
  uint16_t height;
};

static const GxEPD2_AVR_3C_ScreenDimensionType GxEPD2_AVR_3C_ScreenDimensions[]
{
...
class GxEPD2_AVR_3C : public Adafruit_GFX
{
  private:
    static const uint16_t buffer_size = 400;
  public:
    enum GxEPD_Panel
    {
    ...
    GxEPD2_AVR_3C(GxEPD_Panel panel, int8_t cs, int8_t dc, int8_t rst, int8_t busy);
