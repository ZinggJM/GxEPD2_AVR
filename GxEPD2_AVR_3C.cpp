...
const uint8_t GxEPD2_AVR_3C::bw2grey[] =
{
...
void GxEPD2_AVR_3C::fillScreen(uint16_t color)
{
  uint8_t black = 0x00;
  uint8_t red = 0x00;
...
void GxEPD2_AVR_3C::setFullWindow()
{
...
void GxEPD2_AVR_3C::clearScreen(uint8_t black_value, uint8_t red_value)
{
  switch (_panel)
  {
    case GxEPD2::GDEW0154Z04:
...
void GxEPD2_AVR_3C::writeScreenBuffer(uint8_t black_value, uint8_t red_value)
{
  switch (_panel)
  {
    case GxEPD2::GDEW0154Z04:
...
void GxEPD2_AVR_3C::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, NULL, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_AVR_3C::writeImage(const uint8_t* black, const uint8_t* red, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  x -= x % 8; // byte boundary
  w -= x % 8; // byte boundary
...
void GxEPD2_AVR_3C::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_AVR_3C::drawImage(const uint8_t* black, const uint8_t* red, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, red, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_AVR_3C::refresh(bool partial_update_mode)
{
  if (partial_update_mode) refresh(0, 0, WIDTH, HEIGHT);
  else _Update_Full();
}

void GxEPD2_AVR_3C::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
  x -= x % 8; // byte boundary
  w -= x % 8; // byte boundary
  int16_t x1 = x < 0 ? 0 : x; // limit
...
bool GxEPD2_AVR_3C::_nextPagePart()
{
  uint16_t page_ys = _current_page * _page_height;
...
bool GxEPD2_AVR_3C::_nextPageFull154()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t bytes = (_current_page < (_pages - 1) ? _page_height : HEIGHT - page_ys) * _width_bytes;
  if (!_second_phase)
...
bool GxEPD2_AVR_3C::_nextPageFull27()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t bytes = (_current_page < (_pages - 1) ? _page_height : HEIGHT - page_ys) * _width_bytes;
  if (!_second_phase)
...
bool GxEPD2_AVR_3C::_nextPagePart27()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t page_ye = _current_page < (_pages - 1) ? page_ys + _page_height : HEIGHT;
  uint16_t dest_ys = gx_uint16_max(_pw_y, page_ys);
...
void GxEPD2_AVR_3C::_send8pixel(uint8_t black_data, uint8_t red_data)
{
...
void GxEPD2_AVR_3C::_writeCommand(uint8_t c)
{
...
void GxEPD2_AVR_3C::_writeData(uint8_t d)
{
  if (_cs >= 0) digitalWrite(_cs, LOW);
  SPI.transfer(d);
  if (_cs >= 0) digitalWrite(_cs, HIGH);
...
void GxEPD2_AVR_3C::_writeData(const uint8_t* data, uint16_t n)
{
  if (_cs >= 0) digitalWrite(_cs, LOW);
...
void GxEPD2_AVR_3C::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_AVR_3C::_setPartialRamArea27(uint8_t command, uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_AVR_3C::_refreshWindow(uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
  w = (w + 7 + (x % 8)) & 0xfff8; // byte boundary exclusive (round up)
...
void GxEPD2_AVR_3C::_PowerOn(void)
{
  if (!_power_is_on)
  {
    _writeCommand(0x04);
...
void GxEPD2_AVR_3C::_PowerOff(void)
{
  switch (_panel)
  {
    case GxEPD2::GDEW0154Z04:
...
void GxEPD2_AVR_3C::_InitDisplay()
{
