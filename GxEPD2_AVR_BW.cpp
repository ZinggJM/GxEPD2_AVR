...
GxEPD2_AVR_BW::GxEPD2_AVR_BW(GxEPD2::Panel panel, int8_t cs, int8_t dc, int8_t rst, int8_t busy) :
...
void GxEPD2_AVR_BW::drawPixel(int16_t x, int16_t y, uint16_t color)
{
...
bool GxEPD2_AVR_BW::mirror(bool m)
{
  swap (_mirror, m);
  return m;
}
...
void GxEPD2_AVR_BW::fillScreen(uint16_t color)
{
...
void GxEPD2_AVR_BW::setFullWindow()
{
...
void GxEPD2_AVR_BW::powerOff(void)
{
  _PowerOff();
}

void GxEPD2_AVR_BW::drawInvertedBitmap(int16_t x, int16_t y, const uint8_t bitmap[], int16_t w, int16_t h, uint16_t color)
{
...
void GxEPD2_AVR_BW::clearScreen(uint8_t value)
{
  switch (_panel)
  {
    case GxEPD2::GDEP015OC1:
...
void GxEPD2_AVR_BW::writeScreenBuffer(uint8_t value)
{
  if (_initial) clearScreen(value);
  else _writeScreenBuffer(value);
}

void GxEPD2_AVR_BW::_writeScreenBuffer(uint8_t value)
{
  switch (_panel)
  {
    case GxEPD2::GDEP015OC1:
...
void GxEPD2_AVR_BW::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  x -= x % 8; // byte boundary
  w -= x % 8; // byte boundary
...
void GxEPD2_AVR_BW::writeImage(const uint8_t* black, const uint8_t* red, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (black)
  {
...
void GxEPD2_AVR_BW::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_AVR_BW::drawImage(const uint8_t* black, const uint8_t* red, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, red, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_AVR_BW::refresh(bool partial_update_mode)
{
  if (partial_update_mode) refresh(0, 0, WIDTH, HEIGHT);
  else _Update_Full();
}

void GxEPD2_AVR_BW::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
  x -= x % 8; // byte boundary
  w -= x % 8; // byte boundary
  int16_t x1 = x < 0 ? 0 : x; // limit
...
bool GxEPD2_AVR_BW::_nextPageFull()
{
...
bool GxEPD2_AVR_BW::_nextPagePart()
{
  uint16_t page_ys = _current_page * _page_height;
...
bool GxEPD2_AVR_BW::_nextPageFull27()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t bytes = (_current_page < (_pages - 1) ? _page_height : HEIGHT - page_ys) * _width_bytes;
  for (uint16_t idx = 0; idx < bytes; idx++)
...
bool GxEPD2_AVR_BW::_nextPagePart27()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t page_ye = _current_page < (_pages - 1) ? page_ys + _page_height : HEIGHT;
  uint16_t dest_ys = gx_uint16_max(_pw_y, page_ys);
...
bool GxEPD2_AVR_BW::_nextPageFull42()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t bytes = (_current_page < (_pages - 1) ? _page_height : HEIGHT - page_ys) * _width_bytes;
  for (uint16_t idx = 0; idx < bytes; idx++)
...
bool GxEPD2_AVR_BW::_nextPagePart42()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t page_ye = _current_page < (_pages - 1) ? page_ys + _page_height : HEIGHT;
  uint16_t dest_ys = gx_uint16_max(_pw_y, page_ys);
...
bool GxEPD2_AVR_BW::_nextPageFull75()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t bytes = (_current_page < (_pages - 1) ? _page_height : HEIGHT - page_ys) * _width_bytes;
  for (uint16_t idx = 0; idx < bytes; idx++)
...
bool GxEPD2_AVR_BW::_nextPagePart75()
{
  uint16_t page_ys = _current_page * _page_height;
  uint16_t page_ye = _current_page < (_pages - 1) ? page_ys + _page_height : HEIGHT;
  uint16_t dest_ys = gx_uint16_max(_pw_y, page_ys);
...
void GxEPD2_AVR_BW::_send8pixel(uint8_t data)
{
...
void GxEPD2_AVR_BW::_writeCommand(uint8_t c)
{
...
void GxEPD2_AVR_BW::_writeData(uint8_t d)
{
  if (_cs >= 0) digitalWrite(_cs, LOW);
  SPI.transfer(d);
  if (_cs >= 0) digitalWrite(_cs, HIGH);
...
void GxEPD2_AVR_BW::_writeData(const uint8_t* data, uint16_t n)
{
  if (_cs >= 0) digitalWrite(_cs, LOW);
...
void GxEPD2_AVR_BW::_setRamEntryWindow(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint8_t em)
{
...
void GxEPD2_AVR_BW::_setRamArea(uint16_t xs, uint16_t xe, uint16_t ys, uint16_t ye)
{
  _writeCommand(0x44);
  _writeData(xs / 8);
  _writeData(xe / 8);
...
void GxEPD2_AVR_BW::_setRamPointer(uint16_t x, uint16_t y)
{
  _writeCommand(0x4e);
  _writeData(x / 8);
  _writeCommand(0x4f);
...
void GxEPD2_AVR_BW::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_AVR_BW::_refreshWindow(uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
  w = (w + 7 + (x % 8)) & 0xfff8; // byte boundary exclusive (round up)
...
void GxEPD2_AVR_BW::_PowerOn(void)
{
  if (!_power_is_on)
  {
    if (_panel < GxEPD2::GDEW027W3)
...
void GxEPD2_AVR_BW::_PowerOff(void)
{
  if (_panel < GxEPD2::GDEW027W3)
  {
    _writeCommand(0x22);
...
void GxEPD2_AVR_BW::_InitDisplay(uint8_t em)
{
  switch (_panel)
  {
    case GxEPD2::GDEP015OC1:
...
void GxEPD2_AVR_BW::_Init_Full(uint8_t em)
{
  _InitDisplay(em);
  switch (_panel)
  {
...
void GxEPD2_AVR_BW::_Init_Part(uint8_t em)
{
  _InitDisplay(em);
  switch (_panel)
  {
...
void GxEPD2_AVR_BW::_Update_Full(void)
{
  if (_panel < GxEPD2::GDEW027W3)
  {
    _writeCommand(0x22);
...
void GxEPD2_AVR_BW::_Update_Part(void)
{
  if (_panel < GxEPD2::GDEW027W3)
  {
    _writeCommand(0x22);
...
void GxEPD2_AVR_BW::_rotate(uint16_t& x, uint16_t& y, uint16_t& w, uint16_t& h)
{
  switch (getRotation())
  {
    case 1:
