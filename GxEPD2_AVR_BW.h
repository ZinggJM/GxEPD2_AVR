...
struct GxEPD2_AVR_BW_ScreenDimensionType
{
  uint16_t width;
  uint16_t height;
};

static const GxEPD2_AVR_BW_ScreenDimensionType GxEPD2_AVR_BW_ScreenDimensions[]
{
...
class GxEPD2_AVR_BW : public Adafruit_GFX
{
  ...
  public:
    ...
    GxEPD2_AVR_BW(GxEPD_Panel panel, int8_t cs, int8_t dc, int8_t rst, int8_t busy);
